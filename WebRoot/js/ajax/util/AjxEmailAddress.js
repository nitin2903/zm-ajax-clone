...
AjxEmailAddress.addrAnglePat = /(\s*<(((\s*(([\u00A0-\uD7FF\uE000-\uFFFF\x00-\x7F]+|[^\x00-\x1F\x7F\u0080-\uFFFF()<>\[\]:;@\,."\s]+)(\.([\u00A0-\uD7FF\uE000-\uFFFF\x00-\x7F]+|[^\x00-\x1F\x7F\u0080-\uFFFF()<>\[\]:;@\,."\s]+))*)\s*)|(\s*"(([^\\"])|(\\([^\x0A\x0D])))+"\s*))\@((\s*(([\u00A0-\uD7FF\uE000-\uFFFF\x00-\x7F]+|[^\x00-\x1F\x7F\u0080-\uFFFF()<>\[\]:;@\,."\s]+)(\.([\u00A0-\uD7FF\uE000-\uFFFF\x00-\x7F]+|[^\x00-\x1F\x7F\u0080-\uFFFF()<>\[\]:;@\,."\s]+))*)\s*)|(\s*\[(\s*(([^\[\]\\])|(\\([^\x0A\x0D])))+)*\s*\]\s*)))>\s*)$/;
AjxEmailAddress.addrOnlyPat = /^((((\s*(([\u00A0-\uD7FF\uE000-\uFFFF\x00-\x7F]+|[^\x00-\x1F\x7F\u0080-\uFFFF()<>\[\]:;\,."\s]+)(\.([\u00A0-\uD7FF\uE000-\uFFFF\x00-\x7F]+|[^\x00-\x1F\x7F\u0080-\uFFFF()<>\[\]:;@\,."\s]+))*)\s*)|(\s*"(([^\\"])|(\\([^\x0A\x0D])))+"\s*))\@((\s*(([\u00A0-\uD7FF\uE000-\uFFFF\x00-\x7F]+|[^\x00-\x1F\x7F\u0080-\uFFFF()<>\[\]:;@\,."\s]+)(\.([\u00A0-\uD7FF\uE000-\uFFFF\x00-\x7F]+|[^\x00-\x1F\x7F\u0080-\uFFFF()<>\[\]:;@\,."\s]+))*)\s*)|(\s*\[(\s*(([^\[\]\\])|(\\([^\x0A\x0D])))+)*\s*\]\s*))))$/;
...
AjxEmailAddress.addrPat = /(((\s*(([\u00A0-\uD7FF\uE000-\uFFFF\x00-\x7F]+|[^\x00-\x1F\x7F\u0080-\uFFFF()<>\[\]:;\,."\s]+)(\.([\u00A0-\uD7FF\uE000-\uFFFF\x00-\x7F]+|[^\x00-\x1F\x7F\u0080-\uFFFF()<>\[\]:;@\,."\s]+))*)\s*)|(\s*"(([^\\"])|(\\([^\x0A\x0D])))+"\s*))\@((\s*(([\u00A0-\uD7FF\uE000-\uFFFF\x00-\x7F]+|[^\x00-\x1F\x7F\u0080-\uFFFF()<>\[\]:;@\,."\s]+)(\.([\u00A0-\uD7FF\uE000-\uFFFF\x00-\x7F]+|[^\x00-\x1F\x7F\u0080-\uFFFF()<>\[\]:;@\,."\s]+))*)\s*)|(\s*\[(\s*(([^\[\]\\])|(\\([^\x0A\x0D])))+)*\s*\]\s*)))/;
...
AjxEmailAddress.addrPat1 = /(^|"|\s)(((\s*(([\u00A0-\uD7FF\uE000-\uFFFF\x00-\x7F]+|[^\x00-\x1F\x7F\u0080-\uFFFF()<>\[\]:;\,."\s]+)(\.([\u00A0-\uD7FF\uE000-\uFFFF\x00-\x7F]+|[^\x00-\x1F\x7F\u0080-\uFFFF()<>\[\]:;@\,."\s]+))*)\s*)|(\s*"(([^\\"])|(\\([^\x0A\x0D])))+"\s*))\@((\s*(([\u00A0-\uD7FF\uE000-\uFFFF\x00-\x7F]+|[^\x00-\x1F\x7F\u0080-\uFFFF()<>\[\]:;@\,."\s]+)(\.([\u00A0-\uD7FF\uE000-\uFFFF\x00-\x7F]+|[^\x00-\x1F\x7F\u0080-\uFFFF()<>\[\]:;@\,."\s]+))*)\s*)|(\s*\[(\s*(([^\[\]\\])|(\\([^\x0A\x0D])))+)*\s*\]\s*)))/;
